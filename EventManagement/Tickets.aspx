<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tickets.aspx.cs" Inherits="EventManagement.Tickets" %>
                                        ...
                                        <div class="col-md-6">
                                            <form id="form1" runat="server">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="exampleSelectUserType">Event </label>
                                                        <asp:DropDownList ID="ddlteventid" class="form-control" runat="server">
                                                        </asp:DropDownList>
                                                    </div>

                                                    <div class="form-group">
                                                        <label for="exampleSelectUserType">Name</label>
                                                        <asp:DropDownList ID="ddltuserid" class="form-control" runat="server">
                                                        </asp:DropDownList>
                                                    </div>
                                        ...
                                        <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <asp:RangeValidator ID="RangeValidatorQuantity" runat="server" class="form-control"
                                                        ...
                                                        ErrorMessage="Quantity must be a positive integer." Display="Dynamic" />
                                                </div>
