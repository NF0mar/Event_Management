<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Orders.aspx.cs" Inherits="EventManagement.Orders" %>
...
<%--                                                <div class="row">
                                                    <div class="col-md-6">--%>
                                                        <form id="form1" runat="server">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="exampleSelectUserType">Total Price</label>
                                                                <asp:Label ID="lblTotalPrice" runat="server" CssClass="form-control"></asp:Label>
                                                            </div>
