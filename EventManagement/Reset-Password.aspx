<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Reset-Password.aspx.cs" Inherits="EventManagement.Reset_Password" %>
        ...
        <div class="auth-content">
            ...
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <asp:Button ID="btnreset" class="btn btn-primary mb-4 shadow-2" runat="server" Text="Reset Password" />
