<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sponsors.aspx.cs" Inherits="EventManagement.Sponsors" %>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <form id="form1" runat="server">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="exampleInputEvent">Sponsor Name</label>
                                                                <asp:TextBox ID="txtSponsorName" runat="server" CssClass="form-control" placeholder="Name of the Sponsor..." ></asp:TextBox>
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1">Logo Url</label>
                                                                <asp:TextBox ID="txtLogoURL" runat="server" CssClass="form-control" placeholder="Link of the Sponsor Logo..." ></asp:TextBox>
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="exampleDate">Website Url</label>
                                                                <asp:TextBox ID="txtWebsiteURL" runat="server" CssClass="form-control" placeholder="Link of the Sponsor Website..." ></asp:TextBox>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="exampleDate">Event name</label>
                                                                <asp:DropDownList ID="ddlEventID" runat="server" CssClass="form-control"></asp:DropDownList>
                                                            </div>
                                                    ...
                                                    <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                <label for="exampleDate">Contact Name</label>
                                                                <asp:TextBox ID="txtContactName" runat="server" CssClass="form-control" placeholder="Name of the Contact..." ></asp:TextBox>
                                                            </div>

                                                            <div class="form-group">
                                                                <label for="exampleDate">Contact Email</label>
                                                                <asp:TextBox ID="txtContactEmail" runat="server" TextMode="Email" CssClass="form-control" placeholder="Email of the Contact..." ></asp:TextBox>
                                                            </div>
                                                            <div class="form-group">
