<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Events.aspx.cs" Inherits="EventManagement.Events" %>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <form id="form1" runat="server">
                                                            <div class="form-group">
                                                                <label for="exampleInputEvent">Title</label>
                                                                <asp:TextBox ID="txtEventTitle" class="form-control" placeholder="Event Title...." required="" runat="server"></asp:TextBox>
                                                            </div>
                                                            <div class="form-group">
                                                                <label for="exampleInputPassword1">Description</label>
                                                                <textarea id="txtdescription" class="form-control" cols="20" rows="3" placeholder="Event Desricption...." runat="server"></textarea>
                                                            </div>
                                                            ...
                                                            <asp:Label ID="EventTimeLabel" runat="server" Text="Event Time:"></asp:Label>
                                                                <asp:DropDownList ID="ddlEventTime" class="form-control" runat="server">
                                                                    ...
                                                                    <asp:ListItem Value="10:00">12:00 PM</asp:ListItem>
                                                                    <asp:ListItem Value="10:00">01:00 PM</asp:ListItem>
                                                                    <asp:ListItem Value="10:00">02:00 PM</asp:ListItem>
                                                                    <asp:ListItem Value="10:00">03:00 PM</asp:ListItem>
                                                                </asp:DropDownList>
                                                            </div>

                                                            <%--<div class="form-group">
                                                            <asp:Label ID="Label1" runat="server" Text="Event Time:"></asp:Label>
                                                            <asp:TextBox ID="EventTimeTextBox" runat="server" TextMode="Time"></asp:TextBox>
                                                            </div>--%>
                                                    ...
                                                    <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                <asp:Label ID="EventLocationLabel"  runat="server" Text="Event Location:"></asp:Label>
                                                                <asp:TextBox ID="txtlocation"  class="form-control" placeholder="Location of the Event..."  runat="server"></asp:TextBox>    
                                                            </div>


                                                            <div class="form-group">
                                                                <asp:Label ID="EventCapacityLabel" runat="server" Text="Event Capacity:"></asp:Label>
                                                                <asp:TextBox ID="txtcapacity" class="form-control" runat="server"></asp:TextBox>

                                                            </div>

                                                            <div class="form-group">
                                                                <asp:Label ID="Label1" runat="server" Text="Organizer"></asp:Label>
                                                                <asp:DropDownList ID="ddlorganizer" class="form-control" runat="server">
                                                                </asp:DropDownList>
                                                            </div>
                                                    ...
                                                    <div class="input-group mb-3 pr-3 pl-3">
                                                        ...
                                                        <asp:TextBox ID="txtEventID" class="form-control" placeholder="Search" runat="server"></asp:TextBox>
