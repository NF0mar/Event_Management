<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sessions.aspx.cs" Inherits="EventManagement.Sessions" %>
                                                    ...
                                                    <div class="col-md-6">--%>
                                                        <form id="form1" runat="server">
                                                            <div class="form-group">
                                                                ...
                                                                <asp:DropDownList ID="ddlevent" class="form-control" runat="server">
                                                                </asp:DropDownList>
                                                            </div>

                                                            <div class="form-group">
                                                                <asp:Label ID="Label3" runat="server" Text="Speaker"></asp:Label>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <asp:TextBox ID="txtEventTitle" class="form-control" placeholder="Session Title...." required="" runat="server"></asp:TextBox>
                                                            </div>
